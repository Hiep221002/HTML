...
namespace DemoMVC.Controllers
{
    public class DailyController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MaDaily,TenDaily,Diachi,Nguoidaidien,Dienthoi,MaHTPP")] Daily daily)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("MaDaily,TenDaily,Diachi,Nguoidaidien,Dienthoi,MaHTPP")] Daily daily)
        {
            if (id != daily.MaDaily)
            {
                return NotFound();
